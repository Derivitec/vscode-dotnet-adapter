...
export class TestRunner {
	...
	private async RunTest(node: DerivitecTestSuiteInfo | DerivitecTestInfo, isDebug: boolean): Promise<void> {
		...
		await new Promise<void>(async (resolve, reject) => {
			...
			var testOutputFile = `${node.sourceDll}.trx`; //TODO: use autogenerated file name so we don't accidentily pick up an old file on a subsequent run
			...
			this.Runningtest = spawn(
				...
				args,
				{
					...
					env: { // TODO: migrate all (except VSTEST_HOST_DEBUG) environmental variables here to config
